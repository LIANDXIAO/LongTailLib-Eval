...
if __name__ == "__main__":
    ...
    alpha_tag = str(alpha_override) if alpha_override is not None else str(du.alpha)
    if longtail:
        ...
        dir_name = f"MNIST1-{IF_tag}-α{alpha_tag}-{type_tag}-NC{num_clients}"
    else:
        dir_name = f"MNIST1-NC{num_clients}"
