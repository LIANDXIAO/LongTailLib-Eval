...
# 将项目根目录（system文件夹的上一级）加入 sys.path，解决 module 'system' 找不到的问题
...
from flcore.trainmodel.resnet_cifar import *
from flcore.trainmodel.resnet_cifar import resnet8_cifar, resnet8_cifar_512, resnet18_cifar
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        if model_str == "MLR": # convex
            ...
            if args.algorithm in ["FedGraB", "fedgrab", "fedloge", "fedloge2"]:
                pass  # Model will be created in server's __init__
            else:
                if args.algorithm == "FedLoGe":
        ...
        if args.algorithm not in ["FedGraB", "fedgrab", "fedloge", "fedloge2"]:
            print(args.model)
...
if __name__ == "__main__":
    ...
    # Auto-detect num_classes if not explicitly set correctly for dataset
