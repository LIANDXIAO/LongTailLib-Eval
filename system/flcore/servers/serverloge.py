...
from system.flcore.clients.clientloge import ClientLOGE
from system.flcore.servers.serverbase import Server
from system.utils.data_utils import read_client_data
from system.flcore.trainmodel.resnet_cifar import resnet18_cifar
...
class FedLoGe(Server):
    ...
    def __init__(self, args, times):
        ...
        if not isinstance(args.model, nn.Module) and 'cifar' in dataset_name:
